	...
	if not self.options then
		...
		local endcapleft = {
			...
			values = {
				...
				HUMAN=L["Lion"],
				-- SquidFrame
				SF_CASTERS="SF - casters",
				SF_DEATHKNIGHT="SF - deathknight",
				SF_DEATHKNIGHT2="SF - deathknight2",
				SF_DEATHKNIGHT2BLACK="SF - deathknight2black",
				SF_DIABLO1="SF - diablo1",
				SF_DIABLO1_ROTH="SF - diablo1_roth",
				SF_DIABLO2="SF - diablo2",
				SF_DIABLO2_ROTH="SF - diablo2_roth",
				SF_DWARF="SF - dwarf",
				SF_GHOUL="SF - ghoul",
				SF_GNOME="SF - gnome",
				SF_GRIFFON="SF - griffon",
				SF_GUARDIAN="SF - guardian",
				SF_HUMAN="SF - human",
				SF_JAEDEN="SF - jaeden",
				SF_LION="SF - lion",
				SF_MURLOC1="SF - murloc1",
				SF_MURLOC2="SF - murloc2",
				SF_NIGHTELF="SF - nightelf",
				SF_OCTOPUS="SF - octopus",
				SF_ORC="SF - orc",
				SF_PATCHWORK="SF - patchwork",
				SF_SKULL="SF - skull",
				SF_T3WARRIOR="SF - t3warrior",
				SF_TAUREN="SF - tauren",
				SF_TROLL="SF - troll",
				SF_WHELP="SF - whelp"
			},
